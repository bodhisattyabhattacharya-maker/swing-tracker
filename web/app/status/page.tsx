/**
 * Deployment check page, at /status. This is NOT the dashboard - the dashboard is at /.
 *
 * Kept after the grid was built, deliberately. It is the page that answers "is this deployment
 * wired up at all" without depending on the database being reachable, which is exactly the
 * question you have when the grid shows an error panel. It reads no data and never will.
 *
